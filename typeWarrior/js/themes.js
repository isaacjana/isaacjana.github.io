...
export const THEMES = {
    ...
    'serene-forest': {
        ...
        colors: {
            ...
            '--bg-secondary': '#23312e',
            '--bg-tertiary': '#2c3e3a',
            '--bg-card': 'rgba(35, 49, 46, 0.8)',
            '--bg-card-hover': 'rgba(35, 49, 46, 1)',
            '--text-primary': '#d1d9d7',
            '--text-secondary': '#8ba39e',
            '--text-dimmed': '#4a5e5a',
            '--accent-primary': '#a3c9a8',
            '--accent-secondary': '#84b59f',
            '--accent-glow': 'rgba(163, 201, 168, 0.2)',
            '--correct': '#a3c9a8',
            '--incorrect': '#e67e22',
            '--extra': '#d35400',
            '--caret': '#a3c9a8',
            '--border': 'rgba(163, 201, 168, 0.1)',
            '--combo-fire': '#f39c12',
            '--progress-bg': 'rgba(163, 201, 168, 0.05)',
            '--progress-fill': '#a3c9a8',
            '--modal-overlay': 'rgba(0, 0, 0, 0.7)',
            '--modal-bg': 'rgba(27, 38, 35, 0.98)',
            '--shadow': '0 8px 32px rgba(0, 0, 0, 0.3)',
        }
    },
    'midnight-purple': {
        ...
        colors: {
            ...
            '--bg-secondary': '#1a1429',
            '--bg-tertiary': '#241a38',
            '--bg-card': 'rgba(26, 20, 41, 0.8)',
            '--bg-card-hover': 'rgba(26, 20, 41, 1)',
            '--text-primary': '#e0d7f7',
            '--text-secondary': '#9f8dbd',
            '--text-dimmed': '#5e4f7a',
            '--accent-primary': '#bb86fc',
            '--accent-secondary': '#9965f4',
            ...
            '--combo-fire': '#ff4081',
            '--progress-bg': 'rgba(187, 134, 252, 0.05)',
            '--progress-fill': '#bb86fc',
            '--modal-overlay': 'rgba(0, 0, 0, 0.8)',
            '--modal-bg': 'rgba(18, 13, 28, 0.98)',
            '--shadow': '0 8px 32px rgba(187, 134, 252, 0.15)',
        }
    }
};
